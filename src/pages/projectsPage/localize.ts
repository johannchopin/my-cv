const LOCALIZE = {
    de: {
        ...
        project_adventskalender: {
            summary: "IT-Manager für die Erstellung einer progressiven Web-App, die einen Adventskalender für ISFATES-Studenten simuliert. Das gesammelte Geld wird an mehrere Vereine gespendet.",
        },
        project_astropulse: {
