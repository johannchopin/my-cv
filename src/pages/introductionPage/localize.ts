const LOCALIZE = {
    de: {
        introduction_text: "\"Als 20-jähriger Student am Deutsch-Französische Hochschulinstitut für Technik und Wirtschaft (DFHI) interessiere ich mich seit einigen Jahren für Webprogrammierung und Internet. Ehrgeizig und zuverlässig, hoffe ich, dem Profil zu entsprechen, das Sie suchen.\"",
